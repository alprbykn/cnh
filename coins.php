...
<script type="text/javascript">
	...
	console.log(data);
	document.getElementById("cp<?php echo $index;?>").innerHTML = "     "+ data.market_data.current_price.usd.toFixed(3)+"$";
	document.getElementById("ch<?php echo $index;?>").innerHTML = data.market_data.price_change_percentage_1h_in_currency.usd.toFixed(3)+"% "+"/ "+data.market_data.price_change_percentage_24h.toFixed(3)+"% ";
